    ...
    <section id="contact" className="py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-10">
          <h2 className="text-2xl md:text-3xl font-bold text-gray-900">{t.contact.title}</h2>
          <div className="w-16 h-1 bg-blue-700 mx-auto mt-3 rounded-full"></div>
          <p className="text-sm text-gray-600 mt-3">{t.contact.subtitle}</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          <div className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
              <div className="rounded-xl border border-gray-100 bg-white p-4 shadow-sm transition-all hover:-translate-y-1 hover:shadow-md">
                ...
                <div className="text-sm text-gray-700 mt-2 break-words">{contactInfo.phone}</div>
              </div>
              <div className="rounded-xl border border-gray-100 bg-white p-4 shadow-sm transition-all hover:-translate-y-1 hover:shadow-md">
                <div className="flex items-center gap-2 text-blue-700 text-sm font-semibold">
                  <Mail size={16} />
                ...
                <div className="text-sm text-gray-700 mt-2 break-words">{contactInfo.extraEmail}</div>
              </div>
              <div className="rounded-xl border border-gray-100 bg-white p-4 shadow-sm transition-all hover:-translate-y-1 hover:shadow-md">
                <div className="flex items-center gap-2 text-blue-700 text-sm font-semibold">
                  <MapPin size={16} />
                ...
                <div className="text-xs text-gray-700 mt-2 break-words">{t.contact.addressValue}</div>
              </div>
            </div>
            <div className="bg-white p-6 rounded-2xl shadow border border-gray-100">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">{t.contact.infoTitle}</h3>
              <div className="space-y-4 text-sm">
                <p className="flex items-start gap-3 text-gray-700 break-words">
          ...
          <div className="h-64 sm:h-72 bg-gray-200 rounded-xl overflow-hidden shadow border border-gray-100">
            <iframe
              src={mapSrc}
              width="100%"
              height="100%"
