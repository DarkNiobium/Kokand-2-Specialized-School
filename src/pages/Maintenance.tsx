      ...
      <div className="max-w-md w-full bg-white/70 backdrop-blur-xl border border-white/40 rounded-3xl p-8 text-center shadow-[0_20px_50px_rgba(0,0,0,0.05)] relative z-10 transition-all duration-300">
        ...
        <div className="space-y-4 mb-8">
          ...
          <div className="space-y-3 text-sm text-gray-600 leading-relaxed">
            <p className="font-semibold text-brand-dark">
              🇺🇿 Sayt tez orada ishga tushadi. Yangiliklarni ijtimoiy tarmoqlarimizda kuzatib boring!
            </p>
            <p className="text-xs text-gray-500 italic">
              🇷🇺 Сайт скоро запустится. Следите за новостями в наших социальных сетях!
            </p>
            <p className="text-[11px] text-gray-400">
              🇬🇧 The website will be active soon. Follow us on social media for updates!
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 pt-2">
          <a 
            ...
            className="flex flex-col items-center gap-3 bg-brand-gold/10 hover:bg-brand-gold/20 border border-brand-gold/20 p-6 rounded-2xl text-brand-dark transition-all duration-300 font-semibold text-sm group"
          >
            <Send size={28} className="text-brand-gold group-hover:scale-110 transition-transform duration-300" />
            <span>Telegram</span>
          </a>
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer" 
            className="flex flex-col items-center gap-3 bg-brand-navy/5 hover:bg-brand-navy/10 border border-brand-navy/10 p-6 rounded-2xl text-brand-dark transition-all duration-300 font-semibold text-sm group"
          >
            <Instagram size={28} className="text-brand-navy/80 group-hover:scale-110 transition-transform duration-300" />
            <span>Instagram</span>
          </a>
        </div>
